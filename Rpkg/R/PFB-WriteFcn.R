...
#' 
#' @param to.write The array to be written. This must be a 3D array with dimensions nx, ny, nz.
...
#' @param filename The name for the file to be written out
#' @param dx Grid cell size in x dimension.
#' @param dy Grid cell size in y dimension.
#' @param dz Grid cell size in z dimension.
#' @export 
#' 
